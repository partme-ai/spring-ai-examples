# Spring AI 增强扩展：Spring AI 集成 Pangu 大模型
...
与 PartMe 维护的 [`spring-ai-starter-model-huawei-pangu`](../../../spring-ai-starter-model-huawei-pangu/) 配套使用时可对照 Starter 文档获取更多配置选项和最佳实践。