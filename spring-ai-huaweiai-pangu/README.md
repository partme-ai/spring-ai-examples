...
> 演示 **Spring AI** 与 **华为盘古** 的 Chat 等能力集成。依赖版本由父 POM 管理（Spring Boot 3.5.x / Spring AI 1.1.x）。
...
- 本模块通过 `spring-ai-starter-model-openai` 兼容 OpenAI 协议访问华为盘古服务（详见 `pom.xml` 与 `application.properties`）。
