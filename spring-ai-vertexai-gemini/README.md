...
> 演示 **Spring AI** 与 **Google Vertex AI Gemini** 的 Chat 等能力集成。依赖版本由父 POM 管理（Spring Boot 3.5.x / Spring AI 1.1.x）。
...
- 主要 Starter：`spring-ai-starter-model-vertex-ai（以模块 pom 为准）`
